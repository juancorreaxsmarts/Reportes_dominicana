...
class L10nDoTxtReports(models.Model):
    ...
    def action_generate_txt(self):
        ...
        with open("/home/odoo/txt.txt", "w") as file:
            ...
            tipo_bien_servicio = str(self.tipo_bien_servicio)
            ncf = str(self.ncf)
            ncf_modificado = str(self.ncf_modificado)
            invoice_date = str(self.invoice_date)
            fecha_emision = str(self.fecha_emision)
            fecha_pago = str(self.fecha_pago)
            fecha_comprobante_am = str(self.fecha_comprobante_am)
            fecha_comprobante_d = str(self.fecha_comprobante_d)
            fecha_pago_am = str(self.fecha_pago_am)
            fecha_pago_d = str(self.fecha_pago_d)
            monto_facturado = str(self.monto_facturado)
            monto_bienes = str(self.monto_bienes)
            monto_facturado_aitbis = str(self.monto_facturado_aitbis)
            monto_facturado_itbis = str(self.monto_facturado_itbis)
            itbis_retenido = str(self.itbis_retenido)
            itbis_sujeto_proporcionalidad = str(self.itbis_sujeto_proporcionalidad)
            itbis_llevado_costo = str(self.itbis_llevado_costo)
            tipo_itbis_llevado_costo = str(self.tipo_itbis_llevado_costo)
            itbis_adelantar = str(self.itbis_adelantar)
            tipo_itbis_por_adelantar = str(self.tipo_itbis_por_adelantar)
            itbis_percibido_compras = str(self.itbis_percibido_compras)
            tipo_isr_retenido = str(self.tipo_isr_retenido)
            isr_retenido = str(self.isr_retenido)
            monto_facturado_isc = str(self.monto_facturado_isc)
            monto_otros_imp = str(self.monto_otros_imp)
            isr_percibido_compras = str(self.isr_percibido_compras)
            forma_pago = str(self.forma_pago)
            ...
            file.write(tipo_bien_servicio + "\t")
            file.write(ncf + "\t")
            file.write(ncf_modificado + "\t")
            file.write(invoice_date + "\t")
            file.write(fecha_emision + "\t")
            file.write(fecha_pago + "\t")
            file.write(fecha_comprobante_am + "\t")
            file.write(fecha_comprobante_d + "\t")
            file.write(fecha_pago_am + "\t")
            file.write(fecha_pago_d + "\t")
            file.write(monto_facturado + "\t")
            file.write(monto_bienes + "\t")
            file.write(monto_facturado_aitbis + "\t")
            file.write(monto_facturado_itbis + "\t")
            file.write(itbis_retenido + "\t")
            file.write(itbis_sujeto_proporcionalidad + "\t")
            file.write(itbis_llevado_costo + "\t")
            file.write(itbis_adelantar + "\t")
            file.write(tipo_itbis_por_adelantar + "\t")
            file.write(itbis_percibido_compras + "\t")
            file.write(tipo_isr_retenido + "\t")
            file.write(isr_retenido + "\t")
            file.write(monto_facturado_isc + "\t")
            file.write(monto_otros_imp + "\t")
            file.write(isr_percibido_compras + "\t")
            file.write(forma_pago + "\t")
            file.write('0' + "\n")
